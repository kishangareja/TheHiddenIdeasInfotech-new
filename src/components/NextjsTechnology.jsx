                        ...
                        <div className="xl:px-[50px] 3xl:px-[150px] mb-[25px] sm:mb-[50px]">
                            <div className="w-full flex flex-wrap text-black bg-[#ffffff80] p-5 sm:p-10 rounded-md">
                                <div className="w-full lg:w-6/12 text-center sm:text-start mb-5 xl:mb-0">
                                    <h2 className='text-[20px] sm:text-[26px] xl:text-[30px] 2xl:text-[34px] 3xl:text-[40px] font-Secondary font-medium pb-4'>Why Choose The Hidden ideas For NextJS Development?</h2>
                                ...
                                <div className="w-full lg:w-6/12 flex items-center justify-center">
                                    <div className="image flex justify-center">
                                        <img src={nextjsmain} alt="" className='w-[200px] md:w-[300px] 3xl:w-[400px] h-[200px] md:h-[300px] 3xl:h-[400px]' />
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className="xl:px-[50px] 3xl:px-[150px]">
                            <div className="w-full flex flex-wrap text-black bg-[#ffffff80] p-5 sm:p-10 rounded-md">
                                ...
                                <div className="w-full lg:w-6/12 text-center sm:text-start md:ps-5 flex flex-col justify-center">
                                    ...
                                    <p className='text-[14px] xl:text-[16px] pb-3 font-Primary'> From lightning-fast Single Page Applications and interactive E-commerce platforms with server-side rendering to modern Social Media and Community Apps with dynamic routing and API integrations, Next.js provides the flexibility and power needed for today’s web. We also develop custom dashboards, booking systems, educational portals, and content-rich websites that load quickly and provide an exceptional user experience on any device.</p>
                                    <p className='text-[14px] xl:text-[16px] font-Primary'>Next.js empowers us to create modern, high-performance applications with seamless navigation and excellent SEO. We build Single Page Applications with client-side transitions, blazing-fast E-commerce platforms that support dynamic product pages and secure checkouts, and Social Media apps featuring real-time feeds, messaging, and notifications.Leveraging features like server-side rendering, static site generation, and API routes, we ensure your Next.js apps are both powerful and future-ready.</p>
                                </div>
                            </div>
                        </div>
                    </div>
