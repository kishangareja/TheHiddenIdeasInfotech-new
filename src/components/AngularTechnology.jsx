                        ...
                        <div className="xl:px-[50px] 3xl:px-[150px] mb-[25px] sm:mb-[50px]">
                            <div className="w-full flex flex-wrap text-white bg-[#b52e3080] p-5 sm:p-10 rounded-md">
                                <div className="w-full lg:w-6/12 text-center sm:text-start mb-5 xl:mb-0">
                                    <h2 className='text-[20px] sm:text-[26px] xl:text-[30px] 2xl:text-[34px] 3xl:text-[40px] font-Secondary font-medium pb-4 wow animate__animated animate__zoomIn'>Why Choose The Hidden ideas For AngularJS Development?</h2>
                                ...
                                <div className="w-full lg:w-6/12 flex items-center justify-center">
                                    <div className="image flex justify-center wow animate__animated animate__zoomIn">
                                        <img src={angularmain} alt={angularmain} className='w-[200px] md:w-[300px] 3xl:w-[400px] h-[200px] md:h-[300px] 3xl:h-[400px]' />
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className="xl:px-[50px] 3xl:px-[150px]">
                            <div className="w-full flex flex-wrap text-white bg-[#b52e3080] p-5 sm:p-10 rounded-md">
                                ...
                                <div className="w-full lg:w-6/12 text-center sm:text-start md:ps-5 flex flex-col justify-center">
                                    ...
                                    <p className='text-[14px] xl:text-[16px] pb-3 font-Primary wow animate__animated animate__zoomIn'>Using AngularJS, we build dynamic Single Page Applications that provide smooth, real-time experiences without reloading the page.Whether it's a booking system, an educational portal, or a personalized user interface, we leverage AngularJS to create responsive, scalable, and maintainable web applications. </p>
                                    <p className='text-[14px] xl:text-[16px] font-Primary wow animate__animated animate__zoomIn'>From sleek Single Page Applications to advanced admin dashboards, we use AngularJS to build fast, interactive, and maintainable web apps. Our expertise includes crafting E-commerce platforms with seamless product browsing and checkout experiences, Social Media apps with real-time updates and user engagement features, and Learning Management Systems that support courses, progress tracking, and quizzes.</p>
                                </div>
                            </div>
                        </div>
                    </div>
